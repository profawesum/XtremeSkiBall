...
public class AttackState : BaseState
{
    ...
    {
        Vector3 dirToTarget = (Ai.Players[Ai.currentTarget].transform.position - Ai.AiCam.transform.position).normalized;
        float dstToTarget = Vector3.Distance(Ai.AiCam.transform.position, Ai.Players[Ai.currentTarget].transform.position);
